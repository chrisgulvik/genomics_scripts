...
#takes Trimmed unpaired R1 and R2 fq files as input
...
echo '~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~'
echo '~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~'
echo " $SAMPLEL, $SAMPLER,"
echo " and $SAMPLES sequences were read in..."
echo '~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~'
...
echo "        ${Q201} nucleotides are >=Q20 in $SAMPLEL" 
echo "        ${Q301} nucleotides are >=Q30 in $SAMPLEL" 
echo "        ${Q202} nucleotides are >=Q20 in $SAMPLER" 
echo "        ${Q302} nucleotides are >=Q30 in $SAMPLER" 
echo "        ${Q203} nucleotides are >=Q20 in $SAMPLES" 
echo "        ${Q303} nucleotides are >=Q30 in $SAMPLES" 
echo '~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~'
...
echo "        ${PQ201}% nucleotides are >=Q20 in $SAMPLEL" 
echo "        ${PQ301}% nucleotides are >=Q30 in $SAMPLEL" 
echo "        ${PQ202}% nucleotides are >=Q20 in $SAMPLER" 
echo "        ${PQ302}% nucleotides are >=Q30 in $SAMPLER" 
echo "        ${PQ203}% nucleotides are >=Q20 in $SAMPLES" 
echo "        ${PQ303}% nucleotides are >=Q30 in $SAMPLES" 
echo '~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~'
...
"$SAMPLE" "$Q20_TOT" "$Q30_TOT" "$Q201" "$Q202" "$Q203" "$PQ201%" "$PQ202"% "$PQ203"% "$Q301" "$Q302" "$Q303" "$PQ301"% "$PQ302"% "$PQ303"% "$BP_TOT" "$READ_TOT" "$NUM_L" "$NUM_R" "$NUM_single" > "$4"/QualAssessTrimmedSeqs_"$SAMPLE"_results.tsv ;
wait
echo '~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~'
...
> "$4"/QualAssessTrimmedSeqs_"$SAMPLE"_results.log ;
wait
echo '~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~'
