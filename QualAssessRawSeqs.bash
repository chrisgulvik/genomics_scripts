...
echo '~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~'
echo '~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~'
echo " $SEQ1 and $SEQ2 sequences were read in..."
echo '~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~'
...
echo "        ${Q20L} nucleotides are >=Q20 in $SEQ1" 
echo "        ${Q30L} nucleotides are >=Q30 in $SEQ1" 
echo "        ${Q20R} nucleotides are >=Q20 in $SEQ2" 
echo "        ${Q30R} nucleotides are >=Q30 in $SEQ2" 
echo '~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~'
...
echo "        ${PQ20L}% nucleotides are >=Q20 in $SEQ1" 
echo "        ${PQ30L}% nucleotides are >=Q30 in $SEQ1" 
echo "        ${PQ20R}% nucleotides are >=Q20 in $SEQ2" 
echo "        ${PQ30R}% nucleotides are >=Q30 in $SEQ2" 
echo '~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~'
...
echo "        There are $NUM_L reads in $SEQ1" 
echo "        There are $NUM_R reads in $SEQ2" 
echo '~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~'
...
"$SAMPLE" "$Q20_TOT" "$Q30_TOT" "$Q20L" "$Q20R" "$PQ20L%" "$PQ20R%" "$Q30L" "$Q30R" "$PQ30L%" "$PQ30R%" "$BP_TOT" "$READ_TOT" "$NUM_L" "$NUM_R" \
> "$3"/QualAssessRawSeqs_"$SAMPLE"_results.tab ;
wait
echo '~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~'
